...
public static class UsefulMethods
{
    ...
    public static List<Vector3> GetCircleSegments_XZ(Vector3 circleCenter, float radius, int segments)
    {
        ...
        List<Vector3> vertices = GetCircleSegments(circleCenter, radius, 20,10, Space.XZ);
        return vertices;
    }
    ...
    public static List<Vector3> GetCircleSegments_XY(Vector3 circleCenter, float radius, int segments)
    {
        ...
        List<Vector3> vertices = GetCircleSegments(circleCenter, radius, 200,100, Space.XY);
        return vertices;
    }
    ...
    */
    ...
    private static List<Vector3> GetCircleSegments(Vector3 circleCenter, float radius, int longitudeSegments,int latitudeSegments, Space space_2d)
    {
      ...
      //  float angleStep = 360f / (float)segments;
       // float angle = 0f;
        ...
        float longitudeStep = 360f / longitudeSegments;
        float latitudeStep = 180f / latitudeSegments;
        ...
        for (int lat = 0; lat <= latitudeSegments; lat++)
        {
            ...
            for (int lon = 0; lon <= longitudeSegments ; lon++)
            {
                ...
                Vector3 vertex = new Vector3(x, y, z) + circleCenter;
                vertices.Add(vertex);
            }
        }
